...
idx_t cp_als_fg_time(struct genst *gs, struct tensor *t, struct fibertensor *ft, struct csftensor *csftns, idx_t niters, double *cptime, double *mmT, double *othersT , double *mttkrptime, double *comm1time, double * comm2time);
...
idx_t cp_als_fg_dbg(struct genst *gs, struct tensor *t, struct fibertensor *ft, struct csftensor *csftns, idx_t niters, double *cptime);
idx_t cp_als_fg_emb_time(struct genst *gs, struct tensor *t, struct fibertensor *ft, struct csftensor *csftns, idx_t niters, double *cptime, double *mmT, double *othersT , double *mttkrptime, double *comm1time, double * comm2time);

//idx_t cp_als_barrier_fg(struct tensor *t, struct fibertensor *ft, idx_t niters);
